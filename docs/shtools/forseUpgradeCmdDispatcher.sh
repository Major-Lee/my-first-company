...
do
  ...
  curl -H "A-Token-Header: JTNGUlJXAUNKGxFdWlYM" -d "mac=$line&uid=3&&opt=153&subopt=00&extparams={\"url\":\"http://7xl3iu.dl1.z0.glb.clouddn.com/device/build/AP106P06V1.3.4Build8911_TU\",\"upgrade_begin\":\"\",\"upgrade_end\":\"\"}&channel=VAS" "http://vap.bhunetworks.com/bhu_api/v1/cmd/generate"
  echo "$line send ok!"
  sleep 2m
done < $TargetFile
