...
public class UserPublishAccountController extends BaseController{
	...
	public void addPublishAccount(
			...
			@RequestParam(required = false) String legal_person,
			@RequestParam(required = false) String legal_person_certificate,
