...
public class TokenValidateControllerInterceptor extends HandlerInterceptorAdapter {
	...
	static{
		...
		//app获取广告列表
		ignoreTokensValidateUriSet.add("/ad/fetch_adlist_app");
	...
	private static final String patternRegx = "^/((noauth)|(ping)|(dashboard)|(ops)|(common)|(api-docs))";//"^/(noauth)|(statistics)|(device)|(ping)|(common)|(api-docs)";
	/**
	 * 以定义好的字符串前缀
	 * @param url
	 * @return
