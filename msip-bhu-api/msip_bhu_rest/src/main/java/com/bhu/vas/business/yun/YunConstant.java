package com.bhu.vas.business.yun;

public class YunConstant {
	// 七牛云参数
	public static final String QN_ACCESS_KEY = "p6XNq4joNqiFtqJ9EFWdyvnZ6ZBnuwISxvVGdHZg";
	public static final String QN_SECRET_KEY = "edcDVKq1YESjRCk_h5aBx2jqb-rtmcrmwBEBH8-z";
	public static final String QN_BUCKET_URL_FW = "http://devicefw.bhuwifi.com/";
	public static final String QN_BUCKET_URL_OM = "http://deviceom.bhuwifi.com/";
