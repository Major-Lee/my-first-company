...
public class PostRequestUtil {
	public static void main(String[] args) {
		...
		String ss = "responseCode=A001&tn=weixin%3A%2F%2Fwap%2Fpay%3Fprepayid%253Dwx20160824140248";
		
		System.out.println(ss.indexOf("&"));
		System.out.println(ss.substring(21, ss.length()));
	}
