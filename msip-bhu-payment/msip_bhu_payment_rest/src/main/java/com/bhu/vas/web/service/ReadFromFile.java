    ...
    public static void readFileByLines(String fileName) {
        ...
        try {
            ...
            while ((tempString = reader.readLine()) != null) {
            	String[] redisStr = tempString.split(",");
//            	System.out.println(redisStr[0]);
//            	System.out.println(redisStr[1]);
//            	System.out.println(redisStr[2]);
//            	System.out.println(redisStr[3]);
            	ResponsePaymentCompletedNotifyDTO rpcn_dto = new ResponsePaymentCompletedNotifyDTO();
         		rpcn_dto.setSuccess(true);
         		rpcn_dto.setOrderid(redisStr[0]);
         		rpcn_dto.setPayment_type(redisStr[2]);
         		//String fmtDate = BusinessHelper.formatDate(, "yyyy-MM-dd HH:mm:ss");
         		rpcn_dto.setPaymented_ds(redisStr[1]);
         		if(redisStr[3] != null){
         			rpcn_dto.setPayment_proxy_type(redisStr[3]);
         		}
...
//         		}catch(Exception e){
//         			System.out.println("catch exception:"+e.getMessage()+e.getCause());
//         		}
...
//                System.out.println("line " + line + ": " + tempString);
    ...
    public static void main(String[] args) {
        String fileName = "E:/un_notify.txt";
