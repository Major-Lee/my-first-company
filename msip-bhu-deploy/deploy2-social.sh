...
echo 'deploy msip_bhu_unit_social to ...@'$Deploy2ServerSanji
rsync -avz -progress -e 'ssh -p 22'  ./msip_bhu_unit_social/lib/spring*.RELEASE.jar      root@$Deploy2ServerSanji:/BHUData/apps/msip_bhu_unit_social/libs/
rsync -avz -progress -e 'ssh -p 22'  ./msip_bhu_unit_social/lib/msip_*.jar       root@$Deploy2ServerSanji:/BHUData/apps/msip_bhu_unit_social/libs/
rsync -avz -progress -e 'ssh -p 22'  ./msip_bhu_unit_social/classes/com/         root@$Deploy2ServerSanji:/BHUData/apps/msip_bhu_unit_social/classes/com/
echo 'deploy msip_bhu_unit_social successfully @'$Deploy2ServerSanji
...
echo 'deploy msip_bhu_backend_social to ...@'$Deploy2ServerBrook
rsync -avz -progress -e 'ssh -p 22'  ./msip_bhu_backend_social/lib/spring*.RELEASE.jar    root@$Deploy2ServerBrook:/BHUData/apps/msip_bhu_backend_social/libs/
rsync -avz -progress -e 'ssh -p 22'  ./msip_bhu_backend_social/lib/msip_*.jar   root@$Deploy2ServerBrook:/BHUData/apps/msip_bhu_backend_social/libs/
rsync -avz -progress -e 'ssh -p 22'  ./msip_bhu_backend_social/classes/com/     root@$Deploy2ServerBrook:/BHUData/apps/msip_bhu_backend_social/bin/com/
echo 'deploy msip_bhu_backend_social successfully @'$Deploy2ServerBrook
