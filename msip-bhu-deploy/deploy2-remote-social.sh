...
#Deploy2Server=$1
Deploy2ServerSunny=123.56.79.210
#Deploy2ServerSunny=123.56.79.210
#Deploy2ServerFranky=192.168.66.123
Deploy2ServerWeb=123.57.15.204
...
echo '拷贝文件 msip_bhu_social_rest.war到'$CuDateDir
cp ../../msip-bhu-api/msip_bhu_social_rest/target/msip_bhu_social_rest.war ./$CuDateDir
...
unzip -q msip_bhu_unit_social-bin.zip
unzip -qo msip_bhu_unit_social/bin/msip_bhu_unit_social.jar -d msip_bhu_unit_social/classes/

unzip -q msip_bhu_backend_social-bin.zip
unzip -qo msip_bhu_backend_social/bin/msip_bhu_backend_social.jar -d msip_bhu_backend_social/classes/

unzip -qo msip_bhu_social_rest.war -d msip_bhu_social_rest
echo '文件解压过程成功'
...
# echo 'deploy msip_bhu_unit_daemon_processor to ...@'$Deploy2ServerSunny
# rsync -avz -progress -e 'ssh -p 22'  ./msip_bhu_unit_daemon_processor/lib/spring*.RELEASE.jar	root@$Deploy2ServerSunny:/BHUData/apps/msip_bhu_unit_daemon_processor/libs/
# rsync -avz -progress -e 'ssh -p 22'  ./msip_bhu_unit_daemon_processor/lib/msip_*.jar	root@$Deploy2ServerSunny:/BHUData/apps/msip_bhu_unit_daemon_processor/libs/
# rsync -avz -progress -e 'ssh -p 22'  ./msip_bhu_unit_daemon_processor/classes/com/ 		root@$Deploy2ServerSunny:/BHUData/apps/msip_bhu_unit_daemon_processor/classes/com/
# echo 'deploy msip_bhu_unit_daemon_processor successfully @'$Deploy2ServerSunny

# echo 'deploy msip_bhu_unit_devices to ...@'$Deploy2ServerSunny
# rsync -avz -progress -e 'ssh -p 22'  ./msip_bhu_unit_devices/lib/spring*.RELEASE.jar  			root@$Deploy2ServerSunny:/BHUData/apps/msip_bhu_unit_devices/libs/
# rsync -avz -progress -e 'ssh -p 22'  ./msip_bhu_unit_devices/lib/msip_*.jar  			root@$Deploy2ServerSunny:/BHUData/apps/msip_bhu_unit_devices/libs/
# rsync -avz -progress -e 'ssh -p 22'  ./msip_bhu_unit_devices/classes/com/ 				root@$Deploy2ServerSunny:/BHUData/apps/msip_bhu_unit_devices/classes/com/
# echo 'deploy msip_bhu_unit_devices successfully @'$Deploy2ServerSunny

# echo 'deploy msip_bhu_unit_vas to ...@'$Deploy2ServerSunny
# rsync -avz -progress -e 'ssh -p 22'  ./msip_bhu_unit_vas/lib/spring*.RELEASE.jar 			root@$Deploy2ServerSunny:/BHUData/apps/msip_bhu_unit_vas/libs/
# rsync -avz -progress -e 'ssh -p 22'  ./msip_bhu_unit_vas/lib/msip_*.jar  			root@$Deploy2ServerSunny:/BHUData/apps/msip_bhu_unit_vas/libs/
# rsync -avz -progress -e 'ssh -p 22'  ./msip_bhu_unit_vas/classes/com/ 				root@$Deploy2ServerSunny:/BHUData/apps/msip_bhu_unit_vas/classes/com/
# echo 'deploy msip_bhu_unit_vas successfully @'$Deploy2ServerSunny

# echo 'deploy msip_bhu_unit_captchacode to ...@'$Deploy2ServerSunny
# rsync -avz -progress -e 'ssh -p 22'  ./msip_bhu_unit_captchacode/lib/spring*.RELEASE.jar  root@$Deploy2ServerSunny:/BHUData/apps/msip_bhu_unit_captchacode/libs/
# rsync -avz -progress -e 'ssh -p 22'  ./msip_bhu_unit_captchacode/lib/msip_*.jar           root@$Deploy2ServerSunny:/BHUData/apps/msip_bhu_unit_captchacode/libs/
# rsync -avz -progress -e 'ssh -p 22'  ./msip_bhu_unit_captchacode/classes/com/             root@$Deploy2ServerSunny:/BHUData/apps/msip_bhu_unit_captchacode/classes/com/
# echo 'deploy msip_bhu_unit_captchacode successfully @'$Deploy2ServerSunny


# echo 'deploy msip_bhu_unit_rest_urouter to ...@'$Deploy2ServerSunny
# rsync -avz -progress -e 'ssh -p 22'  ./msip_bhu_unit_rest_urouter/lib/spring*.RELEASE.jar  root@$Deploy2ServerSunny:/BHUData/apps/msip_bhu_unit_rest_urouter/libs/
# rsync -avz -progress -e 'ssh -p 22'  ./msip_bhu_unit_rest_urouter/lib/msip_*.jar           root@$Deploy2ServerSunny:/BHUData/apps/msip_bhu_unit_rest_urouter/libs/
# rsync -avz -progress -e 'ssh -p 22'  ./msip_bhu_unit_rest_urouter/classes/com/             root@$Deploy2ServerSunny:/BHUData/apps/msip_bhu_unit_rest_urouter/classes/com/
# echo 'deploy msip_bhu_unit_rest_urouter successfully @'$Deploy2ServerSunny

#echo 'deploy msip_bhu_unit_agent to ...@'$Deploy2ServerSunny
#rsync -avz -progress -e 'ssh -p 22'  ./msip_bhu_unit_agent/lib/spring*.RELEASE.jar      root@$Deploy2ServerSunny:/BHUData/apps/msip_bhu_unit_agent/libs/
#rsync -avz -progress -e 'ssh -p 22'  ./msip_bhu_unit_agent/lib/msip_*.jar       root@$Deploy2ServerSunny:/BHUData/apps/msip_bhu_unit_agent/libs/
#rsync -avz -progress -e 'ssh -p 22'  ./msip_bhu_unit_agent/classes/com/         root@$Deploy2ServerSunny:/BHUData/apps/msip_bhu_unit_agent/classes/com/
...
# echo 'deploy msip_bhu_backend_task to ...@'$Deploy2ServerSunny
# rsync -avz -progress -e 'ssh -p 22'  ./msip_bhu_backend_task/lib/spring*.RELEASE.jar		root@$Deploy2ServerSunny:/BHUData/apps/msip_bhu_backend_task/libs/
# rsync -avz -progress -e 'ssh -p 22'  ./msip_bhu_backend_task/lib/msip_*.jar		root@$Deploy2ServerSunny:/BHUData/apps/msip_bhu_backend_task/libs/
# rsync -avz -progress -e 'ssh -p 22'  ./msip_bhu_backend_task/classes/com/ 		root@$Deploy2ServerSunny:/BHUData/apps/msip_bhu_backend_task/bin/com/
# echo 'deploy msip_bhu_backend_task successfully @'$Deploy2ServerSunny

# echo 'deploy msip_bhu_backend_wifistasniffer to ...@'$Deploy2ServerSunny
# rsync -avz -progress -e 'ssh -p 22'  ./msip_bhu_backend_wifistasniffer/lib/spring*.RELEASE.jar    root@$Deploy2ServerSunny:/BHUData/apps/msip_bhu_backend_wifistasniffer/libs/
# rsync -avz -progress -e 'ssh -p 22'  ./msip_bhu_backend_wifistasniffer/lib/msip_*.jar   root@$Deploy2ServerSunny:/BHUData/apps/msip_bhu_backend_wifistasniffer/libs/
# rsync -avz -progress -e 'ssh -p 22'  ./msip_bhu_backend_wifistasniffer/classes/com/     root@$Deploy2ServerSunny:/BHUData/apps/msip_bhu_backend_wifistasniffer/bin/com/
# echo 'deploy msip_bhu_backend_wifistasniffer successfully @'$Deploy2ServerSunny

# echo 'deploy msip_bhu_backend_modulestat to ...@'$Deploy2ServerSunny
# rsync -avz -progress -e 'ssh -p 22'  ./msip_bhu_backend_modulestat/lib/spring*.RELEASE.jar    root@$Deploy2ServerSunny:/BHUData/apps/msip_bhu_backend_modulestat/libs/
# rsync -avz -progress -e 'ssh -p 22'  ./msip_bhu_backend_modulestat/lib/msip_*.jar   root@$Deploy2ServerSunny:/BHUData/apps/msip_bhu_backend_modulestat/libs/
# rsync -avz -progress -e 'ssh -p 22'  ./msip_bhu_backend_modulestat/classes/com/     root@$Deploy2ServerSunny:/BHUData/apps/msip_bhu_backend_modulestat/bin/com/
# echo 'deploy msip_bhu_backend_modulestat successfully @'$Deploy2ServerSunny

# echo 'deploy msip_bhu_dataimport to ...@'$Deploy2ServerSunny
# rsync -avz -progress -e 'ssh -p 22'  ./msip_bhu_dataimport/lib/spring*.RELEASE.jar  		root@$Deploy2ServerSunny:/BHUData/apps/msip_bhu_dataimport/libs/
# rsync -avz -progress -e 'ssh -p 22'  ./msip_bhu_dataimport/lib/msip_*.jar  		root@$Deploy2ServerSunny:/BHUData/apps/msip_bhu_dataimport/libs/
# rsync -avz -progress -e 'ssh -p 22'  ./msip_bhu_dataimport/classes/com/ 		root@$Deploy2ServerSunny:/BHUData/apps/msip_bhu_dataimport/bin/com/
# echo 'deploy msip_bhu_dataimport successfully @'$Deploy2ServerSunny
...
# echo 'deploy msip_bhu_backend_online to ...@'$Deploy2ServerSunny
# rsync -avz -progress -e 'ssh -p 22'  ./msip_bhu_backend_online/lib/spring*.RELEASE.jar    root@$Deploy2ServerSunny:/BHUData/apps/msip_bhu_backend_online/libs/
# rsync -avz -progress -e 'ssh -p 22'  ./msip_bhu_backend_online/lib/msip_*.jar   root@$Deploy2ServerSunny:/BHUData/apps/msip_bhu_backend_online/libs/
# rsync -avz -progress -e 'ssh -p 22'  ./msip_bhu_backend_online/classes/com/   root@$Deploy2ServerSunny:/BHUData/apps/msip_bhu_backend_online/bin/com/
# echo 'deploy msip_bhu_backend_online successfully @'$Deploy2ServerSunny
