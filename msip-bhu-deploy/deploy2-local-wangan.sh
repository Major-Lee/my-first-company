...
rsync -avz -progress -e 'ssh -p 22'  ./msip_bhu_backend_wangan/lib/spring*.RELEASE.jar   root@$Deploy2Server:/BHUData/apps/msip_bhu_backend_wangan/libs/
rsync -avz -progress -e 'ssh -p 22'  ./msip_bhu_backend_wangan/lib/msip_*.jar    root@$Deploy2Server:/BHUData/apps/msip_bhu_backend_wangan/libs/
rsync -avz -progress -e 'ssh -p 22'  ./msip_bhu_backend_wangan/classes/com/    root@$Deploy2Server:/BHUData/apps/msip_bhu_backend_wangan/bin/com/
