...
echo 'deploy msip_bhu_unit_advertise to ...@'$Deploy2ServerDaemon
rsync -avz -progress -e 'ssh -p 22'  ./msip_bhu_unit_advertise/lib/spring*.RELEASE.jar root@$Deploy2ServerDaemon:/BHUData/apps/msip_bhu_unit_advertise/libs/
rsync -avz -progress -e 'ssh -p 22'  ./msip_bhu_unit_advertise/lib/msip_*.jar  root@$Deploy2ServerDaemon:/BHUData/apps/msip_bhu_unit_advertise/libs/
rsync -avz -progress -e 'ssh -p 22'  ./msip_bhu_unit_advertise/classes/com/    root@$Deploy2ServerDaemon:/BHUData/apps/msip_bhu_unit_advertise/classes/com/
echo 'deploy msip_bhu_unit_advertise successfully @'$Deploy2ServerDaemon
...
echo 'deploy msip_bhu_backend_task_advertise to ...@'$Deploy2Server2
rsync -avz -progress -e 'ssh -p 22'  ./msip_bhu_backend_task_advertise/lib/spring*.RELEASE.jar      root@$Deploy2Server2:/BHUData/apps/msip_bhu_backend_task_advertise/libs/
