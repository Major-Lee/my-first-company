...
public interface IDeviceSharedNetworkRpcService {
	...
	RpcResponseDTO<UserSnkPortalVTO> fetchUserSnks4Portal(int uid,String sharenetwork_type, String tpl);
	...
	RpcResponseDTO<Boolean> clearNetworkConf(int uid, String sharenetwork_type,String template);
