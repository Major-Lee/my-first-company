...
public class WhiteListPermissionThroughNotifyDTO implements PermissionThroughNotifyDTO, Serializable{
	//订单id
	...
	public static WhiteListPermissionThroughNotifyDTO from(Order order, String ait_time, User bindUser){
		...
		WhiteListPermissionThroughNotifyDTO requestDeliverNotifyDto = new WhiteListPermissionThroughNotifyDTO();
