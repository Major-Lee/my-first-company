...
public class TimCustomMsgDefaultDataDTO implements java.io.Serializable{
	...
	public static TimCustomMsgDefaultDataDTO builder(int type, String title,
			String desc, String pic, String url, boolean displayPic, boolean isClick){
		TimCustomMsgDefaultDataDTO dto = new TimCustomMsgDefaultDataDTO();
		dto.setType(type);
		dto.setTitle(title);
		dto.setDesc(desc);
		dto.setPic(pic);
