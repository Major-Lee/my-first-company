...
public class ShareDealDailyUserSummaryProcedureDTO extends AbstractProcedureDTO{
	...
	public String getName() {
		return "msip_bhu_core.daily_user_sharedeal_sum";
	}
	...
	public static void main(String[] argv){
		ShareDealDailyUserSummaryProcedureDTO proDto = new ShareDealDailyUserSummaryProcedureDTO();
	...
	public ShareDealDailyUserSummaryProcedureVTO toVTO(){
		ShareDealDailyUserSummaryProcedureVTO vto = new ShareDealDailyUserSummaryProcedureVTO();
