...
public class PhysicalPermissionThroughNotifyDTO implements PermissionThroughNotifyDTO, Serializable{
	//订单id
	...
	public String getPermissionNotifyType() {
		return PermissionThroughNotifyType.PhysicalPermissionNotify.getPrefix();
	}
	
	public static PhysicalPermissionThroughNotifyDTO from(Order order, Commdity commdity, User bindUser){
		if(order == null || commdity == null) return null;
		PhysicalPermissionThroughNotifyDTO requestDeliverNotifyDto = new PhysicalPermissionThroughNotifyDTO();
	...
	public static PhysicalPermissionThroughNotifyDTO from(Order order, String ait_time, User bindUser){
	...
	public static void main(String[] args){
		PhysicalPermissionThroughNotifyDTO dto = new PhysicalPermissionThroughNotifyDTO();
