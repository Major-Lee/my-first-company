...
public class RewardPermissionThroughNotifyDTO implements PermissionThroughNotifyDTO, Serializable{
	//订单id
	...
	public String getPermissionNotifyType() {
		return PermissionThroughNotifyType.RewardPermissionNotify.getPrefix();
	}
	
	public static RewardPermissionThroughNotifyDTO from(Order order, Commdity commdity, User bindUser){
	...
	public static RewardPermissionThroughNotifyDTO from(Order order, String ait_time, User bindUser){
