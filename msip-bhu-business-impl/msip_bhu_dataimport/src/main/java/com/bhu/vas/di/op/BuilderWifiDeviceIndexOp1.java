 ...
 *
 */
public class BuilderWifiDeviceIndexOp1 {

	
	//public static WifiDeviceIndexService wifiDeviceIndexService = null;
	private static WifiDeviceDataSearchService1 wifiDeviceDataSearchService;
	...
	public static void main(String[] argv) throws IOException, ParseException{
		...
		try{
			...
			wifiDeviceDataSearchService = (WifiDeviceDataSearchService1)ctx.getBean("wifiDeviceDataSearchService1");
