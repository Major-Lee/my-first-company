package com.bhu.vas.di.op.task.finacialstatistics;
 ...
 *
 */
public class FinacialstatisticsMonthlyGroupSummaryBuilderOp {
	...
	public static void main(String[] argv) throws IOException, ParseException{
		...
		try{
			...
			context = new ClassPathXmlApplicationContext(CONFIG, FinacialstatisticsMonthlyGroupSummaryBuilderOp.class);
			context.start();
