 ...
 *
 */
public class WifiDevicePresentCtxService extends AbstractRelationHashCache{
	
	private static class WifiDevicePresentCtxServiceHolder{ 
		private static WifiDevicePresentCtxService instance =new WifiDevicePresentCtxService(); 
	}
	/**
	 * 获取工厂单例
	 * @return
	 */
	public static WifiDevicePresentCtxService getInstance() { 
		return WifiDevicePresentCtxServiceHolder.instance; 
	}
	
	private WifiDevicePresentCtxService(){
	}
	...
	public String getName() {
		return WifiDevicePresentCtxService.class.getName();
	}
	@Override
