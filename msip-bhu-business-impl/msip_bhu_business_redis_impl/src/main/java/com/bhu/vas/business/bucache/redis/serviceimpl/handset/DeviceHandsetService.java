 ...
 *
 */
public class DeviceHandsetService extends AbstractRelationListCache{
	private static class ServiceHolder{ 
		private static DeviceHandsetService instance =new DeviceHandsetService(); 
	}
	/**
	 * 获取工厂单例
	 * @return
	 */
	public static DeviceHandsetService getInstance() { 
		return ServiceHolder.instance; 
	}
	private DeviceHandsetService(){
	}
...
/*		HandsetLogDTO[] previous = previousHandsetLog(key,2);
	...
	public static void main(String[] argv){
		String dmac = "aaaaa";
		String hmac = "bbbbb";
		DeviceHandsetService.getInstance().testbuinsess(dmac, hmac);
		DeviceHandsetService.getInstance().testClear(dmac, hmac);
	...
	public String getName() {
		return DeviceHandsetService.class.getName();
	}
