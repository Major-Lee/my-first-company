...
echo $CLASSPATH
echo 运行应用程序
java  -Xms1024m  -Xmx1024m com.bhu.statistics.util.file.FileHandling |/usr/local/sbin/cronolog /BHUData/logs/statistics/builder_bhu_statistics_index.out.%Y-%m-%d >> /dev/null &
