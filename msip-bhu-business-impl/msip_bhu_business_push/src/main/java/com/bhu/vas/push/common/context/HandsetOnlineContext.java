...
public class HandsetOnlineContext {
	...
	public static final String Ios_HandsetOnline_TextPrefix = "[终端上线]";
	public static final String Ios_VisitorOnline_TextPrefix = "[访客上线]";
	//第一次接入设备的终端额外显示名
...
/*	public String getManufactor() {
	...
	public String getHandsetNameChop(){
		...
		return StringHelper.chopMiddleString(handsetName, 8, StringHelper.ELLIPSIS_STRING_GAP);
	}
