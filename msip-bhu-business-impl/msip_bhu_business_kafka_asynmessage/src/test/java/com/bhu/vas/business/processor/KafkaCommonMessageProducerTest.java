...
public class KafkaCommonMessageProducerTest {
	...
	public static void main(final String args[]) {
		...
		String[] CONFIG = {
				...
				"applicationContext-OutboundKafka-CommonMessage-AdapterParser.xml"
		};
		...
		for (int i = 0; i < 500; i++) {
			...
			outboundSender.send(cmessage,"CommonMessageTopic",String.valueOf(i));
