package com.bhu.vas.business.asyn.spring.activemq.queue.consumer.async;
 ...
 * Time: 17:10:34
 */
public class AsyncDeliverMessageQueueConsumer {
    ...
    public void receive(final String message) {
    	...
    	BusinessStatisticsLogger.doQueueAsyncMessageLog(message);
    	QueueMsgObserverManager.SpringQueueAsyncMessageObserver.notifyMsgComming(message);
