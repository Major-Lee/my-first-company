...
public class AsyncDeliverMessageService {
	...
	public void sendBatchSharedealModifyActionMessage(int uid,String message,
			Boolean cbto,Boolean noapp,Boolean el,boolean customized,String owner_percent,String manufacturer_percent,String distributor_percent,String distributor_l2_percent,
...
//	}
	...
	public void sendOrderDevlierRequestActionMessage(String orderid){
		OrderDeliverRequestDTO dto = new OrderDeliverRequestDTO();
		dto.setOrderid(orderid);
		asyncDeliverMessageQueueProducer.sendPureText(AsyncMessageFactoryBuilder.toJsonHasPrefix(dto));
	}
