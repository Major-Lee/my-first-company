...
public class WifiSimulateProducerTest {
	...
	static{
		devices.add(new WifiInfo("34:36:3b:d0:4b:ac","BN001BI112190AA","192.168.0.1"));
		devices.add(new WifiInfo("72:00:08:75:ef:c0","BN002BI112190AA","192.168.0.2"));
		devices.add(new WifiInfo("72:00:08:75:ef:c1","BN003BI112190AA","192.168.0.3"));
		devices.add(new WifiInfo("06:36:3b:d0:4b:ac","BN004BI112190AA","192.168.0.4"));
		devices.add(new WifiInfo("8a:48:9b:16:97:0f","BN005BI112190AA","192.168.0.5"));
		devices.add(new WifiInfo("36:36:3b:0d:18:00","BN006BI112190AA","192.168.0.6"));
		devices.add(new WifiInfo("C8:9C:DC:E6:77:E6","BN007BI112190AA","192.168.0.7"));
		devices.add(new WifiInfo("D4:BE:D9:E3:8F:EB","BN008BI112190AA","192.168.0.8"));
		devices.add(new WifiInfo("8a:48:9b:16:07:0f","BN009BI112190AA","192.168.0.9"));
		devices.add(new WifiInfo("8a:48:9b:16:17:1f","BN010BI112190AA","192.168.0.10"));
		devices.add(new WifiInfo("8a:48:9b:16:27:2f","BN011BI112190AA","192.168.0.11"));
		devices.add(new WifiInfo("8a:48:9b:16:37:3f","BN012BI112190AA","192.168.0.12"));
		devices.add(new WifiInfo("8a:48:9b:16:47:4f","BN013BI112190AA","192.168.0.13"));
		devices.add(new WifiInfo("8a:48:9b:16:57:5f","BN014BI112190AA","192.168.0.14"));
		devices.add(new WifiInfo("8a:48:9b:16:67:6f","BN015BI112190AA","192.168.0.15"));
		devices.add(new WifiInfo("8a:48:9b:16:77:7f","BN016BI112190AA","192.168.0.16"));
		devices.add(new WifiInfo("8a:48:9b:16:87:8f","BN017BI112190AA","192.168.0.17"));
		devices.add(new WifiInfo("8a:48:9b:16:97:9f","BN019BI112190AA","192.168.0.18"));
		devices.add(new WifiInfo("8a:48:1b:16:07:7f","BN019BI112190AA","192.168.0.19"));
		devices.add(new WifiInfo("8a:48:2b:16:17:6f","BN020BI112190AA","192.168.0.20"));
		devices.add(new WifiInfo("8a:48:3b:16:27:5f","BN000BI112190AA","192.168.0.21"));
	}
	...
	private static String wifi_offline_msg_template = "00000002<?xml version=\"1.0\" encoding=\"UTF-8\"?>"+
									 "<leave_req>"+										
									  	"<ITEM mac=\"%s\" ip=\"%s\" leave_reason=\"3\" />"+
									 "</leave_req>";
	
	private static String wifi_not_exist_msg_template = "00000003<?xml version=\"1.0\" encoding=\"UTF-8\"?>"+
									 "<notexist_req>"+										
									  	"<ITEM mac=\"84:82:f4:05:54:27\"/>"+
									 "</notexist_req>";
