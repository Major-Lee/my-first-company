...
@Repository
public class WifiDeviceCurrentStatusDao extends AbstractCoreDao<String,WifiDeviceCurrentStatus>{//ReadWriteSpliterEntityDao<StorePurchasedItemPK,StorePurchasedItem,Integer>{
