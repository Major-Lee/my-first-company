...
@Repository
public class WifiDeviceVersionFWDao extends AbstractCoreDao<String,WifiDeviceVersionFW>{//ReadWriteSpliterEntityDao<StorePurchasedItemPK,StorePurchasedItem,Integer>{
