...
public class StatisticFincialMonthDao extends AbstractCoreDao<Integer, StatisticFincialMonth>{
	...
	public List<StatisticFincialMonthVTO> findVTOByMonthId(Map<String, Object> map) {
		return super.getSqlSessionSlaverTemplate().selectList(StatisticFincialMonth.class.getName()+".StatisticFincialMonthVTO",map);
