...
@Repository
public class WifiDeviceAlarmDao extends AbstractCoreDao<Integer,WifiDeviceAlarm>{//ReadWriteSpliterEntityDao<StorePurchasedItemPK,StorePurchasedItem,Integer>{
