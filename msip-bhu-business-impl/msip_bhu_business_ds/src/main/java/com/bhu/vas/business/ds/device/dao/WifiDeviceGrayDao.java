...
@Repository
public class WifiDeviceGrayDao extends AbstractCoreDao<String,WifiDeviceGray>{//ReadWriteSpliterEntityDao<StorePurchasedItemPK,StorePurchasedItem,Integer>{
