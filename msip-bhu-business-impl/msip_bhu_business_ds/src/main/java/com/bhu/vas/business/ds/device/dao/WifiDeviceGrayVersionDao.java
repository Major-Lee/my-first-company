...
@Repository
public class WifiDeviceGrayVersionDao extends AbstractCoreDao<WifiDeviceGrayVersionPK,WifiDeviceGrayVersion>{//ReadWriteSpliterEntityDao<StorePurchasedItemPK,StorePurchasedItem,Integer>{
