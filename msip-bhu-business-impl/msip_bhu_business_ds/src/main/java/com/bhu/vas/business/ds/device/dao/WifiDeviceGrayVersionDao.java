...
@Repository
public class WifiDeviceGrayVersionDao extends AbstractCoreDao<Integer,WifiDeviceGrayVersion>{//ReadWriteSpliterEntityDao<StorePurchasedItemPK,StorePurchasedItem,Integer>{
