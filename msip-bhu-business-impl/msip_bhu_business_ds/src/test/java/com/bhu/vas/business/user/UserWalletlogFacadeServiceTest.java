...
public class UserWalletlogFacadeServiceTest extends BaseTest{
	...
	@Test
	public void test() {
		String start_time = "2015-07-09";
		String end_time = "2016-08-09";
		Map<String, Object> sum= userWalletLogService.getEntityDao().fetchCashSumAndCountByUid(100299, start_time,end_time,"");
