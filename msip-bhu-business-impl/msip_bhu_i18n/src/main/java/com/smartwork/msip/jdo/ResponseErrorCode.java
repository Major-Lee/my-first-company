...
//	WIFIDEVICE_GRAY_DeviceUnitType_NOTMATCHED("770", "wifidevice.gray.deviceunittype.notmatched"),
	...
	AUTH_CAPTCHA_IDENTITY_NOT_EXIST("284","auth.captcha.identity.not.exist"),
	...
	USER_MOBILE_NOT_BE_REGISTER("305","user.mobile.not.be.register"),
...
//	USER_TOKENS_INVALID("311","user.tokens.invalid"),
	...
	USER_DEVICE_SHAREDNETWORK_TEMPLATE_CLEAR_NOTALLOW("382", "user.device.sharednetwork.template.clear.notallow"),
	...
	VALIDATE_COMMDITY_AMOUNT_LITTLE("432","validate.commdity.amount.toolittle"),
