...
public class LocaleUtils {
    ...
    private static String resourceBaseName = "i18n/cmanager_i18n";

    public static void setResourceBaseName(String resBaseName){
    	resourceBaseName = resBaseName;
    }
    ...
    public static String[][] getTimeZoneList() {
        Locale jiveLocale = JingGlobals.getLocale();
    ...
    public static String getTimeZoneName(String zoneID, Locale locale) {
        ...
        int hours = offset / (int) JingConstants.HOUR;
        int minutes = (offset % (int) JingConstants.HOUR) / (int) JingConstants.MINUTE;
    ...
    public static String getLocalizedString(String key) {
        return getLocalizedString(key, JingGlobals.getLocale(), null);
    }
    ...
    public static String getLocalizedString(String key, List arguments) {
        return getLocalizedString(key, JingGlobals.getLocale(), arguments);
    }
        ...
        try {
            ...
            if (arguments != null) {
                ...
                try {
                	...
                	logger.error(e.getMessage(),"Unable to format resource string for key: "
        	...
        	logger.warn(mre.getMessage(),"Missing resource for key: " + key
