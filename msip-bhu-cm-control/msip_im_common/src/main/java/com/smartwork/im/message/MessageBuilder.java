...
public class MessageBuilder {
	...
	public static Message builderCliPeerMediaMessage(String from,String to,String cid,boolean isContext,char mediaType,String body){
		return builderCliPeerMediaMessage(from,to,cid,isContext,mediaType,body,StringHelper.EMPTY_STRING_GAP);
	}
	
	public static Message builderCliPeerMediaMessage(String from,String to,String cid,boolean isContext,char mediaType,String body,String dur){
		Message message = new Message();
		message.setTo(to);//new String[]{to});
		message.setFrom(from);
...
//		String[] intro_mobileno_ay = intro_mobilenos.split(StringHelper.COMMA_STRING_GAP);
	...
	public static void main(String[] argv){
		Message message = MessageBuilder.builderCliPeerMediaReadedMessage("100012", "200048", "20140712141819bwjP200048-200037.zip");
		System.out.println(JsonHelper.getJSONString(message));
		
		message = MessageBuilder.builderCliBroadcastMessage("100012", "200048,200049,200050",MessageType.ChatPeerMediaMessage.getDisplay(), "20140712141819bwjP100012-200048.zip","0.0");
		System.out.println(JsonHelper.getJSONString(message));
