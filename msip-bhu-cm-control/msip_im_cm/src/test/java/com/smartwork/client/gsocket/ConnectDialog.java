...
public class ConnectDialog extends JDialog {
    ...
    public ConnectDialog(Frame owner) throws HeadlessException {
        ...
        //serverAddress = "127.0.0.1:5222";
        serverAddress = "192.168.1.106:5222";
        username = "user" + Math.round(Math.random() * 10);

        final JTextField serverAddressField = new JTextField(serverAddress);
        final JTextField usernameField = new JTextField("200082");
        final JTextField atokenField = new JTextField("MCpLU1NTVUtBH0BYCFZZdkgHB1I=");
        ...
        content.add(new JLabel("AccessToken"));
        content.add(atokenField);
