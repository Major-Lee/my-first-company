 ...
 */
public class SessionAuthenticatedTask extends ClientTask {

    private InetAddress address;

    public SessionAuthenticatedTask(String streamID, InetAddress address) {
        super(streamID);
    ...
    public void run() {
        ...
        workerThread.clientSessionAuthenticated(streamID, address);//.clientSessionCreated(streamID, address);
    }
